...
![Day](https://img.shields.io/badge/Day-25%20of%2081-blue?style=flat-square)
...
| Skill          | Level                | Status                                        |
| -------------- | -------------------- | --------------------------------------------- |
| **SQL**        | Basic → Intermediate | ✅ Solid — JOINs, Subqueries, GROUP BY working |
...
| Day 25 | SQL Subqueries Mastery — 15 queries: IN / NOT IN, scalar subqueries (AVG, MAX), FROM subqueries (derived tables), correlated subqueries, HAVING filters, real-world patterns (top customers, revenue month, city filtering) |
...
* Subqueries — Scalar, `IN`/`NOT IN`, Derived Tables, Correlated
* String Functions
* `BETWEEN` / `NOT BETWEEN`
...
<div align="center">
<sub>Updated after Day 25 · Honest progress tracking · No sugarcoating</sub>
</div>
